    ...
    return (
        <TiltCard className="h-full">
            <motion.div
                ...
                onClick={onSelect}
                className={cn(
                    "group relative h-full rounded-3xl border border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-md overflow-hidden transition-shadow hover:shadow-2xl hover:shadow-blue-500/10 flex flex-col",
