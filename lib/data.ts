...
export const skillCategories: SkillCategory[] = [
    {
        ...
        skills: [
            ...
            { name: "TypeScript 5.9", icon: "Code" },
            { name: "Tailwind 4.1+", icon: "Palette" },
            { name: "Framer Motion", icon: "Sparkles" },
            { name: "Three.js", icon: "Box" },
            { name: "shadcn/ui", icon: "Component" },
            { name: "Headless UI", icon: "LayoutDashboard" },
        ],
    },
    {
        title: "Backend",
        ...
        skills: [
            { name: "Node.js 24", icon: "Hexagon" },
            { name: "NestJS 10+", icon: "Box" },
            { name: "Express.js", icon: "Zap" },
            { name: "GraphQL", icon: "GitBranch" },
            { name: "REST APIs", icon: "Link" },
            { name: "tRPC", icon: "ArrowLeftRight" },
    ...
    },
    {
        ...
        skills: [
            { name: "React Native 0.88+", icon: "Smartphone" },
            { name: "Expo", icon: "Rocket" },
            { name: "TypeScript", icon: "Code" },
            { name: "Push Notifications", icon: "Bell" },
            { name: "Real-time Chat", icon: "MessageCircle" },
            { name: "Maps Integration", icon: "Map" },
            { name: "Offline Support", icon: "WifiOff" },
        ],
    },
    {
        title: "Desktop",
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "MongoDB 7", icon: "Leaf" },
            { name: "Prisma 7.1+", icon: "Layers" },
            { name: "Supabase 2.86+", icon: "Cloud" },
            { name: "Redis", icon: "Zap" },
